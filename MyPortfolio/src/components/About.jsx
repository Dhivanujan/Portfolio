...
const About = () => {
  ...
  return (
      ...
      <div ref={ref}>
        ...
        >
          ...
          <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto text-lg">
            Passionate engineer turning complex challenges into elegant
            solutions
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-10 items-start">
          ...
          >
            <div className="relative group">
              ...
              <div className="relative p-6 sm:p-8 lg:p-10 rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/80 backdrop-blur-sm shadow-xl">
                ...
                <div className="space-y-4 sm:space-y-5 text-slate-600 dark:text-slate-300 leading-relaxed">
                  <p className="text-base sm:text-lg">
                    ...
                    with a passion for building scalable systems, reliable
                    infrastructure, and efficient cloud-based solutions.
                  </p>
                  <p className="text-sm sm:text-base">
                    ...
                    , including cloud architecture (AWS, Azure, GCP),
                    containerization, and network engineering. I design systems
                    that prioritize scalability, performance, and reliability.
                  </p>
                  <p className="text-sm sm:text-base">
                    From developing{" "}
                    ...
                    to architecting CI/CD pipelines and building cloud-native
                    solutions, I deliver end-to-end systems that are reliable,
    ...
    desc: "Building scalable backend systems, RESTful APIs, and modular applications focused on performance, maintainability, and real-world use cases.",
  ...
  },
  {
    icon: Cpu,
    title: "Cloud & DevOps",
    desc: "Designing and deploying cloud infrastructure (AWS, Azure, GCP), CI/CD pipelines, containerized applications, Kubernetes orchestration, and Infrastructure as Code with Terraform.",
  ...
  },
  {
    ...
    desc: "Designing secure and scalable network architectures, including VPCs, load balancing, IAM, and implementing security best practices for production systems.",
    ...
    iconBg: "bg-amber-500/10",
              ...
              >
                {/* Hover gradient */}
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${feature.gradient} opacity-0 group-hover:opacity-[0.03] transition-opacity duration-300`}
                />
                ...
                <div className="relative z-10">
                  <h4 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white mb-1.5 sm:mb-2 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300">
                    {feature.title}
                  </h4>
