...
import { Mail, Linkedin, Github, Send, Loader2, MapPin, Phone, ArrowRight, Sparkles, CheckCircle } from "lucide-react";
        ...
        <Section id="contact" className="relative pb-32 overflow-hidden">
            ...
            >
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mt-3 mb-5 text-slate-900 dark:text-white">
                    Let's <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">Connect</span>
                </h2>
                        ...
                        <form ref={formRef} className="space-y-5 sm:space-y-6 relative z-10" onSubmit={handleSubmit}>
                            <div className="grid md:grid-cols-2 gap-5 sm:gap-6">
                                ...
                                <div className="relative">
                                    ...
                                    />
                                    <label htmlFor="email" className="absolute left-5 -top-2.5 px-2 bg-white dark:bg-slate-900 text-xs font-semibold text-indigo-600 dark:text-indigo-400 transition-all duration-300 peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-500 dark:peer-placeholder-shown:text-slate-500 peer-placeholder-shown:font-normal peer-focus:-top-2.5 peer-focus:text-xs peer-focus:font-semibold peer-focus:text-indigo-600 dark:peer-focus:text-indigo-400">
                                        Email Address
                                    </label>
                                </div>
                            </div>
                            ...
                            <div className="relative">
                                ...
                                <input 
                                    ...
                                    placeholder="Subject"
                                />
                                <label htmlFor="subject" className="absolute left-5 -top-2.5 px-2 bg-white dark:bg-slate-900 text-xs font-semibold text-indigo-600 dark:text-indigo-400 transition-all duration-300 peer-placeholder-shown:top-4 peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-500 dark:peer-placeholder-shown:text-slate-500 peer-placeholder-shown:font-normal peer-focus:-top-2.5 peer-focus:text-xs peer-focus:font-semibold peer-focus:text-indigo-600 dark:peer-focus:text-indigo-400">
                                    Subject (Optional)
                                </label>
                            </div>
