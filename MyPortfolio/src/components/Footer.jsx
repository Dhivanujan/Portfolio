                ...
                <div className="grid md:grid-cols-3 gap-8 items-center">
                    ...
                    <div className="flex justify-center gap-4">
                        ...
                        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" 
                           className="p-3 rounded-full bg-white/5 border border-white/10 text-slate-400 hover:text-primary hover:border-primary/30 hover:bg-primary/10 transition-all duration-300 hover:shadow-[0_0_20px_rgba(99,102,241,0.2)]">
                            <Linkedin className="w-5 h-5" />
                        </a>
                        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" 
                           className="p-3 rounded-full bg-white/5 border border-white/10 text-slate-400 hover:text-indigo-400 hover:border-indigo-400/30 hover:bg-indigo-400/10 transition-all duration-300 hover:shadow-[0_0_20px_rgba(129,140,248,0.2)]">
